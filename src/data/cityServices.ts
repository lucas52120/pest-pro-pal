...
export const serviceDefinitions = [
  ...
  },
  {
    ...
    getContent: (city: string, department: string) => ({
      ...
      cta: `Appelez F&G Nuisibles au 07.88.17.45.86 pour protéger vos bâtiments professionnels à ${city} en ${department}. Devis gratuit sur site, solutions pérennes garanties.`,
    }),
  },
  {
    ...
    getContent: (city: string, department: string) => ({
      ...
      cta: `Contactez F&G Nuisibles au 07.88.17.45.86 pour l'élimination des pigeons chez vous à ${city} en ${department}. Devis gratuit, intervention rapide et discrète.`,
    }),
  },
  {
    slug: "taupes",
