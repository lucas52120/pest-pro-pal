...
export const serviceDefinitions = [
  {
    ...
    getContent: (city: string, department: string) => ({
      ...
      cta: `Contactez F&G Nuisibles au 07.88.17.45.86 pour une intervention rapide à ${city} et ses environs en ${department}. Diagnostic gratuit, intervention garantie.`,
    }),
  },
  {
    ...
    getContent: (city: string, department: string) => ({
      ...
      intro: `F&G Nuisibles, située à Chaumont en Haute-Marne (52), propose des traitements professionnels contre les insectes nuisibles à ${city} en ${department} : cafards, punaises de lit, blattes et autres parasites. Ces insectes se reproduisent rapidement et représentent un risque sanitaire important pour votre foyer ou vos locaux professionnels. Notre expertise nous permet d'identifier rapidement le type d'infestation et de mettre en place le traitement le plus adapté.`,
  ...
  },
  {
    ...
    getContent: (city: string, department: string) => ({
      ...
      intro: `Des bruits dans les cloisons à ${city} ? Des traces de grignotage ? F&G Nuisibles, située à Chaumont en Haute-Marne (52), intervient rapidement à ${city} en ${department} pour éliminer rats, souris et rongeurs de votre habitation ou de vos locaux professionnels. La présence de rongeurs est un risque sanitaire majeur et peut causer des dégâts importants sur vos installations électriques et votre isolation.`,
  ...
  },
  {
    ...
    getContent: (city: string, department: string) => ({
      metaDescription: `Dépigeonnisation à ${city} en ${department}. Protection durable des bâtiments contre les pigeons. FG Nuisibles. Tél : 07.88.17.45.86.`,
      seoTitle: `Dépigeonnisation à ${city} en ${department}`,
      intro: `F&G Nuisibles, située à Chaumont en Haute-Marne (52), vous propose ses services de dépigeonnisation à ${city} en ${department} pour vous débarrasser des pigeons et divers oiseaux nuisibles. Les pigeons causent des dégâts importants sur les bâtiments : fientes acides qui détériorent les façades, risques sanitaires, nuisances sonores. Préservez l'hygiène de vos locaux et évitez les dégradations liées aux déjections et maladies.`,
      expertise: `F&G Nuisibles utilise différentes méthodes sans blesser ni tuer les volatiles à ${city} en ${department} : installation de filets, de picots, de systèmes de répulsion laser, efficaces et discrets. Ainsi, les volatiles ne vont plus se poser ou se nicher sur vos bâtiments. Nos solutions sont conformes à la réglementation et respectueuses des animaux.`,
      ...
      cta: `Appelez F&G Nuisibles au 07.88.17.45.86 pour protéger vos bâtiments à ${city} en ${department}. Devis gratuit sur site, solutions pérennes garanties.`,
    }),
  },
  {
    ...
    heroImage: serviceDepigeonnage,
    getContent: (city: string, department: string) => ({
      metaDescription: `Élimination de pigeons à ${city} en ${department}. Solutions professionnelles et durables. FG Nuisibles. Tél : 07.88.17.45.86.`,
      seoTitle: `Élimination Pigeons à ${city} en ${department}`,
      intro: `F&G Nuisibles, située à Chaumont en Haute-Marne (52), vous propose ses services pour vous débarrasser des pigeons et divers oiseaux à ${city} en ${department}. Les pigeons représentent un véritable fléau pour les bâtiments et la santé publique. Leurs fientes acides dégradent les façades, les toitures et les équipements, tandis que les maladies qu'ils transmettent constituent un risque sanitaire majeur. Préservez l'hygiène de vos locaux et évitez les dégradations liées aux déjections et maladies.`,
      expertise: `F&G Nuisibles utilise différentes méthodes sans blesser ni tuer les volatiles à ${city} en ${department} comme l'installation de filets, de picots, de systèmes de répulsion laser, efficaces et discrets. Ainsi, les volatiles ne vont plus se poser ou se nicher sur vos bâtiments. Notre expertise nous permet d'adapter nos solutions à chaque configuration : immeubles, entrepôts, monuments, copropriétés.`,
      method: `Diagnostic approfondi de votre site à ${city} pour identifier les zones de nidification et de perchage. Mise en place de dispositifs professionnels adaptés : filets anti-pigeons, pics inox, systèmes de répulsion électrique ou laser. Nettoyage et désinfection complète des zones souillées. Suivi post-intervention pour garantir des résultats durables.`,
      cta: `Contactez F&G Nuisibles au 07.88.17.45.86 pour l'élimination des pigeons à ${city} en ${department}. Devis gratuit, intervention rapide et discrète.`,
    }),
  },
  {
    slug: "taupes",
    ...
    getContent: (city: string, department: string) => ({
      ...
      intro: `Des taupinières envahissent votre pelouse à ${city} en ${department} ? F&G Nuisibles, située à Chaumont en Haute-Marne (52), utilise la méthode traditionnelle de piégeage, la plus efficace et respectueuse de l'environnement. Protégez vos espaces verts avec notre expertise terrain reconnue dans toute la région.`,
