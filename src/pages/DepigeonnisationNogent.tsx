...
const TITLE = "Dépigeonnisation à Nogent en Haute-Marne 52 | G&F Nuisibles";
const DESCRIPTION = "Pigeons à Nogent ? G&F Nuisibles, expert en dépigeonnage en Haute-Marne 52, protège vos bâtiments durablement. Diagnostic gratuit 7j/7.";

const DepigeonnisationNogent = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://www.gf-nuisibles.fr/services/depigeonnisation/nogent",
        "name": TITLE,
  ...
  <>
    <Helmet>
      ...
      <meta name="description" content={DESCRIPTION} />
        <link rel="canonical" href="https://www.gf-nuisibles.fr/services/depigeonnisation/nogent" />
    ...
    <CityServicePage
      ...
      serviceCallTitle="PIGEONS ENVAHISSANTS À NOGENT ?"
...
export default DepigeonnisationNogent;
