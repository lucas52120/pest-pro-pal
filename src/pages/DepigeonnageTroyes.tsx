...
const TITLE = "Dépigeonnage à Troyes dans l'Aube 10 | G&F Nuisibles";
  ...
  return (
    <>
      ...
      <CityServicePage
        ...
        expertise="Notre savoir-faire en Aube (10) nous permet d'adapter chaque intervention à la configuration du bâtiment. Nous combinons plusieurs techniques pour une efficacité maximale et durable."
        ...
        cta="Pigeons à Troyes ? Contactez G&F Nuisibles au 07.88.17.45.86 pour un dépigeonnage professionnel garanti."
      />
    </>
  );
};

export default DepigeonnageTroyes;
