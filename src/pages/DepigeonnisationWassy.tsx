...
const DepigeonnisationWassy = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://www.gf-nuisibles.fr/services/depigeonnisation/wassy",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/services/depigeonnisation/wassy" />
      ...
      <CityServicePage
        ...
        cta="Problème de pigeons à Wassy ? Appelez G&F Nuisibles au 07.65.25.67.92 pour une solution durable."
      />
    </>
  );
};
