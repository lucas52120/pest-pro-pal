...
const TITLE = "Dépigeonnage à Dijon en Côte-d'Or 21 | G&F Nuisibles";
  ...
  return (
    <>
      ...
      <CityServicePage
        ...
        cta="Pigeons à Dijon ? Contactez G&F Nuisibles au 07.88.17.45.86 pour un dépigeonnage professionnel garanti."
      />
    </>
  );
};

export default DepigeonnageDijon;
