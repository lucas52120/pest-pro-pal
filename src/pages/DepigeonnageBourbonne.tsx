...
const TITLE = "Dépigeonnage à Bourbonne-les-Bains en Haute-Marne 52 | G&F Nuisibles";
  ...
  return (
    <>
      ...
      <CityServicePage
        ...
        expertise="Nous intervenons à Bourbonne-les-Bains et dans toute la Haute-Marne pour le dépigeonnage de bâtiments résidentiels, commerciaux et publics. Solutions durables adaptées à chaque configuration architecturale."
        ...
        cta="Problème de pigeons à Bourbonne-les-Bains ? Appelez G&F Nuisibles au 07.88.17.45.86 pour une solution durable."
      />
    </>
  );
};

export default DepigeonnageBourbonne;
