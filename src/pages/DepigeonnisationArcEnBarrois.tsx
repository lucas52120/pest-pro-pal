...
const DepigeonnisationArcEnBarrois = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://gf-nuisibles.fr/services/depigeonnisation/arc-en-barrois",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://gf-nuisibles.fr/services/depigeonnisation/arc-en-barrois" />
