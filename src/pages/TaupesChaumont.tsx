...
const TITLE = "Taupes à Chaumont en Haute-Marne 52 | G&F Nuisibles";
const DESCRIPTION = "Taupes dans votre jardin à Chaumont ? G&F Nuisibles, taupier professionnel en Haute-Marne 52. Piégeage efficace et écologique, devis gratuit.";

const TaupesChaumont = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://www.gf-nuisibles.fr/taupes-chaumont",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/taupes-chaumont" />
      ...
      <CityServicePage
        ...
        serviceCallTitle="TAUPES DANS VOTRE JARDIN À CHAUMONT ?"
