  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "Service",
        "name": TITLE,
        "url": "https://www.gf-nuisibles.fr/deratisation-bar-sur-aube",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/deratisation-bar-sur-aube" />
      ...
      <CityServicePage
        ...
        cta="Ne laissez pas les rongeurs s'installer à Bar-sur-Aube. Appelez le 07.65.25.67.92 pour une expertise certifiée et un devis sans engagement."
        faqItems={FAQ_ITEMS}
      />
    </>
  );
