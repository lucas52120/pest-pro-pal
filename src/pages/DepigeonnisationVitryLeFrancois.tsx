...
const DepigeonnisationVitryLeFrancois = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://gf-nuisibles.fr/services/depigeonnisation/vitry-le-francois",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://gf-nuisibles.fr/services/depigeonnisation/vitry-le-francois" />
