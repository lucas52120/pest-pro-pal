...
const TaupesBourbonne = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://www.gf-nuisibles.fr/taupes-bourbonne-les-bains",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/taupes-bourbonne-les-bains" />
      ...
      <CityServicePage
        ...
        cta="Taupes dans votre jardin à Bourbonne-les-Bains ? Contactez G&F Nuisibles au 07.65.25.67.92 pour un devis gratuit."
      />
    </>
  );
};
