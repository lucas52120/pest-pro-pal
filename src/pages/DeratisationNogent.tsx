  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "Service",
        "name": TITLE,
        "url": "https://www.gf-nuisibles.fr/deratisation-nogent",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/deratisation-nogent" />
      ...
      cta="Ne laissez pas les rongeurs s'installer à Nogent. Contactez G&F Nuisibles au 07.65.25.67.92 — intervention rapide 7j/7, diagnostic gratuit."
      faqItems={FAQ_ITEMS}
    />
    </>
  );
