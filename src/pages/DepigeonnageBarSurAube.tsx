...
const TITLE = "Dépigeonnage à Bar-sur-Aube dans l'Aube 10 | G&F Nuisibles";
  ...
  return (
    <>
      ...
      <CityServicePage
        ...
        expertise="Experts en dépigeonnage en Aube (10), nous proposons des solutions adaptées à chaque type de bâtiment : pics anti-pigeons, filets de protection, systèmes de répulsion électrique et capture."
...
export default DepigeonnageBarSurAube;
