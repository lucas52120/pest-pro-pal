...
const DepigeonnisationBarSurAube = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://www.gf-nuisibles.fr/services/depigeonnisation/bar-sur-aube",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/services/depigeonnisation/bar-sur-aube" />
      ...
      <CityServicePage
        ...
        cta="Protégez vos bâtiments à Bar-sur-Aube. Appelez le 07.65.25.67.92 pour une solution anti-pigeons professionnelle et durable."
        faqItems={FAQ_ITEMS}
      />
    </>
  );
