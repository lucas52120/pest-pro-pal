...
const DepigeonnisationBourbonne = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://gf-nuisibles.fr/services/depigeonnisation/bourbonne-les-bains",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://gf-nuisibles.fr/services/depigeonnisation/bourbonne-les-bains" />
