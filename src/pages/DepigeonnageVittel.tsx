...
const TITLE = "Dépigeonnage à Vittel dans les Vosges 88 | G&F Nuisibles";
  ...
  return (
    <>
      ...
      <CityServicePage
        ...
        expertise="Notre savoir-faire en Vosges (88) nous permet d'adapter chaque intervention à la configuration du bâtiment. Nous combinons plusieurs techniques pour une efficacité maximale et durable."
        ...
        cta="Pigeons à Vittel ? Contactez G&F Nuisibles au 07.88.17.45.86 pour un dépigeonnage professionnel garanti."
      />
    </>
  );
};

export default DepigeonnageVittel;
