  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "Service",
        "name": TITLE,
        "url": "https://www.gf-nuisibles.fr/deratisation-chatillon-sur-seine",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/deratisation-chatillon-sur-seine" />
      ...
      <CityServicePage
        ...
        cta="Protégez votre habitat à Châtillon-sur-Seine. Contactez G&F Nuisibles au 07.65.25.67.92 pour un diagnostic gratuit et une intervention rapide."
        faqItems={FAQ_ITEMS}
      />
    </>
  );
