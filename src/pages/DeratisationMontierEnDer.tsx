...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "Service",
      "name": TITLE,
        "url": "https://gf-nuisibles.fr/deratisation-montier-en-der",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://gf-nuisibles.fr/deratisation-montier-en-der" />
      ...
      <CityServicePage
        ...
        cta="Protégez votre habitat à Montier-en-Der. Appelez G&F Nuisibles au 07.65.25.67.92 pour un devis gratuit et une intervention rapide."
        faqItems={FAQ_ITEMS}
      />
    </>
  );
