...
const DepigeonnisationChalindrey = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://www.gf-nuisibles.fr/services/depigeonnisation/chalindrey",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/services/depigeonnisation/chalindrey" />
