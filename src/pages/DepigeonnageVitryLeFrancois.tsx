...
const TITLE = "Dépigeonnage à Vitry-le-François dans la Marne 51 | G&F Nuisibles";
...
const DepigeonnageVitryLeFrancois = () => {
  return (
    <>
      <Helmet>
        <title>{TITLE}</title>
      ...
      <CityServicePage
        ...
        expertise="Notre savoir-faire en Marne (51) nous permet d'adapter chaque intervention à la configuration du bâtiment. Nous combinons plusieurs techniques pour une efficacité maximale et durable."
        ...
        cta="Pigeons à Vitry-le-François ? Contactez G&F Nuisibles au 07.88.17.45.86 pour un dépigeonnage professionnel garanti."
      />
    </>
  );
};

export default DepigeonnageVitryLeFrancois;
