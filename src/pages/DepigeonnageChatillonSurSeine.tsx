...
const TITLE = "Dépigeonnage à Châtillon-sur-Seine en Côte-d'Or 21 | G&F | G&F Nuisibles";
...
const DepigeonnageChatillonSurSeine = () => {
  return (
    <>
      <Helmet>
        <title>{TITLE}</title>
      ...
      <CityServicePage
        ...
        expertise="Notre savoir-faire en Côte-d'Or (21) nous permet d'adapter chaque intervention à la configuration du bâtiment. Nous combinons plusieurs techniques pour une efficacité maximale et durable."
        ...
        cta="Pigeons à Châtillon-sur-Seine ? Contactez G&F Nuisibles au 07.88.17.45.86 pour un dépigeonnage professionnel garanti."
      />
    </>
  );
};

export default DepigeonnageChatillonSurSeine;
