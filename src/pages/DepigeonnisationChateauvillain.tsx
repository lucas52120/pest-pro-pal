...
const DepigeonnisationChateauvillain = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://gf-nuisibles.fr/services/depigeonnisation/chateauvillain",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://gf-nuisibles.fr/services/depigeonnisation/chateauvillain" />
