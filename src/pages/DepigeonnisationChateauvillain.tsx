...
const TITLE = "Dépigeonnisation à Châteauvillain en Haute-Marne 52 | G&F Nuisibles";
const DESCRIPTION = "Pigeons à Châteauvillain ? G&F Nuisibles installe des protections anti-pigeons en Haute-Marne 52. Dépigeonnage garanti.";

const DepigeonnisationChateauvillain = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://www.gf-nuisibles.fr/services/depigeonnisation/chateauvillain",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.gf-nuisibles.fr/services/depigeonnisation/chateauvillain" />
...
export default DepigeonnisationChateauvillain;
