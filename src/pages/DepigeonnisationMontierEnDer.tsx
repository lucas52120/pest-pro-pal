...
const DepigeonnisationMontierEnDer = () => {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "url": "https://gf-nuisibles.fr/services/depigeonnisation/montier-en-der",
        "name": TITLE,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://gf-nuisibles.fr/services/depigeonnisation/montier-en-der" />
